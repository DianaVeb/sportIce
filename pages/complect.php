...
<div class="bb w py">
    ...
    <div class="pagination">
        <?php if ($page > 1): ?>
            <a href="?page=complect&page_num=<?= $page - 1; ?>" class="prev">Назад</a>
        <?php endif; ?>

        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
            <a href="?page=complect&page_num=<?= $i; ?>" class="<?= $i === $page ? 'active' : ''; ?>">
                <?= $i; ?>
            </a>
        <?php endfor; ?>

        <?php if ($page < $totalPages): ?>
            <a href="?page=complect&page_num=<?= $page + 1; ?>" class="next">Вперед</a>
        <?php endif; ?>
    </div>
</div>
